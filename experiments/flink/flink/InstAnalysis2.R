...
for(app in c(4:10)){
  for(fnt in start_fun:end_fun){
    s<-paste(sprintf("C:/Users/szhang026/Documents/Profile-experiments/flink-tracing/log/genlib/%s/app_function_gaps%s",app,fnt),".txt", sep="")
    print(s)
    res <- log(scan(s))
    #length(res)
    #F10 <-ecdf(res)
...
for(app in c(4:10)){
  for(fnt in start_fun:end_fun){
    #s<-paste(sprintf("C:/Users/szhang026/Documents/Profile-experiments/flink-tracing/log/genlib/%s/storm_function_gaps%s",app,fnt),".txt", sep="")
    s<-paste(sprintf("C:/Users/szhang026/Documents/Profile-experiments/flink-tracing/log/genlib/%s/gaps%s",app,fnt),".txt", sep="")
    #s<-paste(sprintf("C:/Users/szhang026/Documents/Profile-experiments/flink-tracing/log/genlib/%s/app_function_gaps%s",app,fnt),".txt", sep="")
    print(s)
    res <- log10(scan(s))
