...
import flink.applications.util.math.RunningMedianCalculator;

import java.util.HashMap;
import java.util.Map;

import static flink.applications.constants.SmartGridConstants.Field;
import static flink.applications.constants.SmartGridConstants.SlidingWindowAction;
