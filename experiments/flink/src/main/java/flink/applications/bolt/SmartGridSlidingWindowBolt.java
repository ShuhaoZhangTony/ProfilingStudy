...
import flink.applications.util.window.SlidingWindow;
import flink.applications.util.window.SlidingWindowCallback;
import flink.applications.util.window.SlidingWindowEntry;

import java.util.List;

import static flink.applications.constants.SmartGridConstants.*;
