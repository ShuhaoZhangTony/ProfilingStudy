...
public interface LinearRoadFConstants extends BaseConstants {
    ...
    interface TunedConfiguration {
        ...
        int LatestAverageVelocityThreads_core8 = 4;

        int DispatcherBoltThreads_core16 = 1;
        int AverageSpeedThreads_core16 = 1;
        int LatestAverageVelocityThreads_core16 = 1;
        int DispatcherBoltThreads_core32 = 1;
        int AverageSpeedThreads_core32 = 2;
        int LatestAverageVelocityThreads_core32 = 1;
        int DispatcherBoltThreads_core8_HP = 1;
        int AverageSpeedThreads_core8_HP = 1;
        int LatestAverageVelocityThreads_core8_HP = 1;
        int DispatcherBoltThreads_core8_Batch = 1;
        int AverageSpeedThreads_core8_Batch = 1;
        int LatestAverageVelocityThreads_core8_Batch = 1;
        int DispatcherBoltThreads_core32_HP_Batch = 1;
        int AverageSpeedThreads_core32_HP_Batch = 2;
        int LatestAverageVelocityThreads_core32_HP_Batch = 2;
