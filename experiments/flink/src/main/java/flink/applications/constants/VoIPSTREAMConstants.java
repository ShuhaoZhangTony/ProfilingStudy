...
public interface VoIPSTREAMConstants extends BaseConstants {
    ...
    interface TunedConfiguration {
        ...
        int VAR_DETECT_THREADS_core8 = 10;
        int FOFIR_THREADS_core8 =1;

        int VAR_DETECT_THREADS_core16 = 1;
        int FOFIR_THREADS_core16 = 1;
        int VAR_DETECT_THREADS_core32 = 2;
        int FOFIR_THREADS_core32 = 1;
        int VAR_DETECT_THREADS_core8_HP = 1;
        int FOFIR_THREADS_core8_HP = 1;
        int VAR_DETECT_THREADS_core8_Batch = 1;
        int FOFIR_THREADS_core8_Batch = 1;
        int VAR_DETECT_THREADS_core32_HP_Batch = 1;
        int FOFIR_THREADS_core32_HP_Batch = 2;
