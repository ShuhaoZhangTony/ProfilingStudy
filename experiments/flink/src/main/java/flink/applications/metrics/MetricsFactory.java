package flink.applications.metrics;
...
import static flink.applications.util.config.Configuration.*;
        ...
        switch (reporterType) {
            case SLF4J_REPORTER:
                reporter = Slf4jReporter.forRegistry(registry)
                        .outputTo(LoggerFactory.getLogger("flink.applications.metrics"))
