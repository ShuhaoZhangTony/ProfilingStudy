...
import flink.applications.constants.SpikeDetectionConstants;
 ...
 * @author mayconbordin
 */
public class NullSink_SD extends BaseSink {
    ...
    public void initialize() {
        LOG = LoggerFactory.getLogger(NullSink_SD.class);
        start_true = 0;
        end = 0;
        end_index = 0;
        //loadConfig();
...
//				}
                ...
                try {
                    ...
                    client.killTopology("spike-detection"); //provide topology name
                    System.exit(0);
