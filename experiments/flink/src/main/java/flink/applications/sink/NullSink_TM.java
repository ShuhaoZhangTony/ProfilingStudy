...
import flink.applications.constants.TrafficMonitoringConstants;
 ...
 * @author mayconbordin
 */
public class NullSink_TM extends BaseSink {
    ...
    public void initialize() {
        LOG = LoggerFactory.getLogger(NullSink_TM.class);
        start_true = 0;
        end = 0;
        end_index = 0;
        //loadConfig();
...
//				}
                ...
                try {
                    ...
                    client.killTopology("traffic-monitoring"); //provide topology name
                    System.exit(0);
