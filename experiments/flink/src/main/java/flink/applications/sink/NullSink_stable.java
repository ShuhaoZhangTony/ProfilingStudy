 ...
 * @author mayconbordin
 */
public class NullSink_stable extends BaseSink {
    private static final Logger LOG = LoggerFactory.getLogger(NullSink_stable.class);
    ...
    public void initialize() {
        ...
        index_e = 0;
        pid = true;
        need_warm_up = true;//we test warm up directly! We need to bypass warm up stage only when we need to profile!
