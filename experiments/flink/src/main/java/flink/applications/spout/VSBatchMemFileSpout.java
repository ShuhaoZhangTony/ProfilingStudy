 ...
 */
public class VSBatchMemFileSpout extends AbstractSpout {
    private static final Logger LOG = LoggerFactory.getLogger(VSBatchMemFileSpout.class);
...
//            }
//        }
        System.out.print("Failed:" + (String) msgId + "\n");
    }
