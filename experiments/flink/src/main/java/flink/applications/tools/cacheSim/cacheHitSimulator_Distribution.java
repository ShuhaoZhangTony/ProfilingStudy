package flink.applications.tools.cacheSim;
...
//    private static double total_execution_cycles;//total execution cycles.
//    private static double[] num_cycles_per_function;//execution cycles per function.
    private static int[] generate_funcTrace(int num_functionTypes, Object[] num_cycles_per_function, int total_execution_cycles) throws IOException {
    ...
    private static Vector2D cacheHit(int[] event_trace, Map<Integer, Integer> instruction_per_function, int policy) throws IOException {
                    ...
                    switch (policy) {
                        case 0: {
                            while (cache_used + instruction_per_function.get(i) > cache_size) {
                                ...
                                List<Integer> keys = new ArrayList<Integer>(cached.keySet());
    ...
    public static void main(String[] arg) throws IOException {
        ...
        switch (app) {
            case 0: {//analysis wc
                path = "C:\\Users\\szhang026\\Documents\\storm-app\\src\\InstructionInspection\\wc";
                sc = new Scanner(new File(path + "\\wc.csv"));
                break;
            }
            case 1: {//analysis fd
                path = "C:\\Users\\szhang026\\Documents\\storm-app\\src\\InstructionInspection\\fd";
                sc = new Scanner(new File(path + "\\fd.csv"));
                break;
            }
            case 2: {//analysis lg
                path = "C:\\Users\\szhang026\\Documents\\storm-app\\src\\InstructionInspection\\lg";
                sc = new Scanner(new File(path + "\\lg.csv"));
                break;
            }
            case 3: {//analysis sd
                path = "C:\\Users\\szhang026\\Documents\\storm-app\\src\\InstructionInspection\\sd";
                sc = new Scanner(new File(path + "\\sd.csv"));
                break;
            }
            case 4: {//analysis vs
                path = "C:\\Users\\szhang026\\Documents\\storm-app\\src\\InstructionInspection\\vs";
                sc = new Scanner(new File(path + "\\vs.csv"));
                break;
            }
            case 5: {//analysis tm
                path = "C:\\Users\\szhang026\\Documents\\storm-app\\src\\InstructionInspection\\tm";
                sc = new Scanner(new File(path + "\\tm.csv"));
                break;
            }
            case 6: {//analysis lr
                path = "C:\\Users\\szhang026\\Documents\\storm-app\\src\\InstructionInspection\\lr";
        ...
        System.out.println("compulsory_miss ratio:" + (double) result.getX() / event_trace.length);
        System.out.println("Access_miss ratio:" + (double) result.getY() / event_trace.length);
        System.out.println("Cache Miss:" + (double) (result.getX() + result.getY()) / event_trace.length);
