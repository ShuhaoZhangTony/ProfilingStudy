package flink.applications.topology.special_LRF;

import backtype.storm.Config;
import backtype.storm.tuple.Fields;
import flink.applications.constants.WordCountConstants;
import flink.applications.topology.base.BasicTopology;
import flink.applications.topology.special_LRF.bolt.*;
import flink.applications.topology.special_LRF.bolt.batch.*;
import flink.applications.topology.special_LRF.model.Accident;
import flink.applications.topology.special_LRF.model.AccidentImmutable;
import flink.applications.topology.special_LRF.model.VehicleInfo;
import flink.applications.topology.special_LRF.tools.StopWatch;
...
import flink.applications.topology.special_LRF.types.TravelTimeRequest;
import flink.applications.topology.special_LRF.types.util.SegmentIdentifier;
import flink.applications.topology.special_LRF.util.aeolus.utils.TimestampMerger;
...
import static flink.applications.constants.LinearRoadFConstants.Conf;
import static flink.applications.constants.LinearRoadFConstants.PREFIX;
    ...
    public FlinkTopology buildTopology() {
        ...
        if (batch == 1) {
            ...
            builder.setBolt(TopologyControl.ACCOUNT_BALANCE_BOLT_NAME, new BatchAccountBalanceBolt(), AccountBalanceBoltThreads)
                    ...
                    .shuffleGrouping(TopologyControl.TOLL_NOTIFICATION_BOLT_NAME,//same vid go to same account balance.
                            TopologyControl.TOLL_ASSESSMENTS_STREAM_ID);
