 ...
 * #_
 */
package flink.applications.topology.special_LRF.spout;
...
import flink.applications.topology.special_LRF.bolt.DispatcherBolt;
...
public class SocketClientSpoutPure extends BaseRichSpout {
     ...
     *
     * @param host the host the socket is opened on
     * @param port the port the socket is opened on
     */
