...
public class NUMA_analysis {
    ...
    public static void main(String[] arg) {
        try {
            int app=4;
            Scanner sc = new Scanner(new File("C:\\Users\\szhang026\\Documents\\Profile-experiments\\ExperimentResults\\FlinkResults\\NUMA-analysis\\"+app+"\\thread.csv"));
            String title = sc.nextLine();
            String[] col_name = title.split(",");
//            System.out.println(title);
            ...
            sc = new Scanner(new File("C:\\Users\\szhang026\\Documents\\Profile-experiments\\ExperimentResults\\FlinkResults\\NUMA-analysis\\"+app+"\\thread.txt"));
            while (sc.hasNextLine()) {
            ...
            Collections.sort(r_list,Collections.reverseOrder(new Comparator<record>() {//sort by CPU_CLK_UNHALTED first
                @Override
                public int compare(record o1, record o2) {
                    return (o1.L2_Hit.compareTo(o2.L2_Hit));
                }
            }));
            for(record r: r_list){
