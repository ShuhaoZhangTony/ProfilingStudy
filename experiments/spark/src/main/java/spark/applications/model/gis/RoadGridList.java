package spark.applications.model.gis;
...
import spark.applications.constants.TrafficMonitoringConstants;
...
public class RoadGridList {
    ...
    public RoadGridList(Configuration config, String path) throws SQLException, IOException {
        ...
        idKey = config.getString(TrafficMonitoringConstants.Conf.ROAD_FEATURE_ID_KEY);
