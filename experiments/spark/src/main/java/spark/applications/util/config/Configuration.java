package spark.applications.util.config;

import org.apache.commons.lang3.math.NumberUtils;
import org.apache.spark.SparkConf;
import spark.applications.util.data.DataTypeUtils;
...
public class Configuration extends HashMap {
    ...
    public static SparkConf fromProperties(Properties properties) {
        SparkConf config = new SparkConf();
        for (String key : properties.stringPropertyNames()) {
            config.set(key, String.valueOf(parseString(properties.getProperty(key))));
        }
