...
package spark.applications.util.input;

import spark.applications.constants.LinearRoadConstants;
...
public class HistoryLoadingNotifierClient {
    ...
    public static boolean isHistoryLoaded() {
        ...
        String host = LinearRoadConstants.HISTORY_COMPONENT_HOST;

        try {
            Socket skt = new Socket(host, LinearRoadConstants.HISTORY_LOADING_NOTIFIER_PORT);
