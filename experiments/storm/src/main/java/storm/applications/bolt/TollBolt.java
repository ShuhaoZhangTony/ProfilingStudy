...
import storm.applications.util.event.AccidentEvent;
import storm.applications.util.event.LAVEvent;
import storm.applications.util.event.NOVEvent;
...
import static storm.applications.constants.LinearRoadConstants.*;

/**
 * Created by szhang026 on 20/2/2016.
 */
public class TollBolt extends storm.applications.bolt.base.AbstractBolt {
