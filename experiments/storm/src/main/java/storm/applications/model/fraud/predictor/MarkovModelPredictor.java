...
import static storm.applications.constants.FraudDetectionConstants.DEFAULT_MODEL;
...
public class MarkovModelPredictor extends ModelBasedPredictor {
    ...
    public MarkovModelPredictor(Configuration conf) {
        ...
        String mmKey = conf.getString(OS_prefix.concat(Conf.MARKOV_MODEL_KEY), null);
        String model;
