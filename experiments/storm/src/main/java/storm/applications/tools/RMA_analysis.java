 ...
 */
public class RMA_analysis {

    public static void main(String[] arg) {
        try {
            int app=10;
            String path="C:\\Users\\szhang026\\Documents\\Profile-experiments\\Results\\AllPrefetchDisabled\\vtune_c0m0\\"+app;
            Scanner sc = new Scanner(new File(path+"\\thread8.csv"));
...
//            System.out.println(title);
            ...
            sc = new Scanner(new File(path+"\\thread8.txt"));
            while (sc.hasNextLine()) {
