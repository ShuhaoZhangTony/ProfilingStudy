...
public class cacheHitSimulator_PI_generic {
    ...
    static String path = "C:\\Users\\I309939\\Documents\\myworkingonpapers\\profiling\\experimentResults(VLDBSubmission)\\storm-tracing\\log\\genlib";
    private static int app_start = 4;
    private static int app_end = 10;
    private static boolean spilit_method = true;
    private static int method = 1;//method 0: system method+user method. 1: user method only.
