...
public class AccidentDetectionBolt extends BaseRichBolt {
    ...
    public void execute(Tuple input) {
        ...
        if (minute > this.currentMinute) {
            ...
            this.collector.emit(TopologyControl.ACCIDENTS_STREAM_ID, new AccidentTuple(inputPositionReport_cp, new Short(minute)));
        }
                ...
                if (stoppedCars == null) {
                    ...
                    if (stoppedCars.size() > 1) {
                        this.collector.emit(
                                ...
                                new AccidentTuple(inputPositionReport_cp, new Short(minute),
