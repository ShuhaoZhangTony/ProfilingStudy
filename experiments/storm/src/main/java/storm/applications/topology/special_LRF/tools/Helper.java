 ...
 * #_
 */
package storm.applications.topology.special_LRF.tools;
...
public class Helper {
    ...
    /**
     * the key for the
     * {@link BaseRichBolt#prepare(java.util.Map, org.apache.storm.task.TopologyContext, org.apache.storm.task.OutputCollector) }
