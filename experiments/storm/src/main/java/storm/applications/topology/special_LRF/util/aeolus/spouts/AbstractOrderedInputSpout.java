 ...
 * #_
 */
package storm.applications.topology.special_LRF.util.aeolus.spouts;
...
import storm.applications.topology.special_LRF.util.aeolus.utils.StreamMerger;
...
public abstract class AbstractOrderedInputSpout<T> implements IRichSpout {
     ...
     *
     * @param streamID the ID of the stream the fields ought to be declared on
     */
     ...
     *
     * @param index     The partition id the tuple belongs to.
     * @param timestamp The timestamp of the tuple.
     * @param tuple     The tuple to be emitted.
     ...
     *
     * @param partitionId The ID of the partition to be closed.
